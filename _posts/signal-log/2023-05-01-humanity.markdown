...
{% include image-grid.html images=images images-alt=images-alt caption="Left: 152 Elizabeth (New York, NY). Top right: Modern Art Museum of Fort Worth (Fort Worth, TX). Bottom right: Langen Foundation (Neuss, Germany)." grid-layout="three-left" %}
