...
category: broadcast
banner: "/assets/img/posts/magimirai-leeks-rule.png"
src: [Cohost, https://cohost.org/bitto/post/1140287-please-refrain-from]
excerpt_separator: ""
---

{% include image.html url="/assets/img/posts/magimirai-leeks-rule.png" alt="A highlighted rule stating to &quot;Please refrain from bringing raw leeks to the venue.&quot;" caption="Participation rules for Magical Mirai 2023" %}
...
{% include image.html url="/assets/img/posts/comiket-cos-rules.png" alt="Presentation slide showing a timeline of rule changes at Comiket from C80 until C84" caption="The evolution of cosplay rules at Comiket" %}
...
{% include image.html url="/assets/img/posts/mikufes-09.jpg" alt="Miku FES’09 promo image with a footnote rule stating &quot;※ネギは持ち込み禁止です&quot;" caption="Miku FES’09 announced with a footnote prohibiting leeks" %}
...
{% include image.html url="/assets/img/posts/magimirai-leeks-sign.jpg" alt="Posted sign rules for Magical Mirai 2022, including one prohibiting leeks" caption="No leeks allowed at Magical Mirai 2022" %}
